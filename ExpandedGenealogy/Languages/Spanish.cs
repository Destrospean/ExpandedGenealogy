...
namespace Destrospean.Lang.ExpandedGenealogy
{
    public class SPA : PlayerLanguage
    {
        ...
        {
            string generationalDistance = (isStepRelative ? Common.GetStepAncestorInfo(descendant.GetGenealogyPlaceholder(), ancestor.GetGenealogyPlaceholder()) : Common.GetAncestorInfo(descendant, ancestor)).GenerationalDistance.ToString();
        ...
        public override string GetDescendantOfSiblingString(bool isFemale, Genealogy siblingOfAncestor, Genealogy descendantOfSibling, bool isStepRelative = false)
        {
            foreach (Genealogy sibling in siblingOfAncestor.Siblings)
            {
                if (descendantOfSibling.IsAncestor(sibling) || (isStepRelative && descendantOfSibling.IsStepAncestor(sibling)))
                {
                    ...
                    string descendantTitle, generationalDistance = (isStepRelative ? Common.GetStepAncestorInfo(descendantOfSibling.GetGenealogyPlaceholder(), sibling.GetGenealogyPlaceholder()) : Common.GetAncestorInfo(descendantOfSibling, sibling)).GenerationalDistance.ToString();
                    ...
                    return Tuning.kShow1stCousinsAsCousins ? Localization.LocalizeString(isFemale, isHalfRelative && !Tuning.kShowHalfRelativesAsFullRelatives ? "Destrospean/ExpandedGenealogy:GreatNxHalfNephew" : "Destrospean/ExpandedGenealogy:GreatNxNephew", descendantTitle.ToLower()) : Localization.LocalizeString(isFemale, isHalfRelative && !Tuning.kShowHalfRelativesAsFullRelatives ? "Destrospean/ExpandedGenealogy:NthHalfCousinNxRemovedDownward" : "Destrospean/ExpandedGenealogy:NthCousinNxRemovedDownward", "1", Localization.LocalizeString(isFemale, "Destrospean/ExpandedGenealogy:OrdinalSuffixNoun1"), descendantTitle.ToLower(), isStepRelative ? Localization.LocalizeString(isFemale, "Destrospean/ExpandedGenealogy:Step") : "");
                }
            }
            return "";
        }
        ...
        public override string GetDistantRelationString(bool isFemale, Genealogy sim, DistantRelationInfo distantRelationInfo)
        {
            ...
            string ancestorTitle = "", degree = (distantRelationInfo.Degree + 1).ToString(), greatNxUncleEntryKey = "Destrospean/ExpandedGenealogy:GreatNx" + (isHalfRelative && !Tuning.kShowHalfRelativesAsFullRelatives ? "Half" : "") + (distantRelationInfo.ClosestDescendant == sim.GetGenealogyPlaceholder() ? "Uncle" : "Nephew"), nthCousinNxRemovedEntryKey = string.Format("Destrospean/ExpandedGenealogy:Nth{0}CousinNxRemoved{1}ward", isHalfRelative && !Tuning.kShowHalfRelativesAsFullRelatives ? "Half" : "", distantRelationInfo.ClosestDescendant == sim.GetGenealogyPlaceholder() ? "Up" : "Down");
                        ...
                        if (distantRelationInfo.TimesRemoved <= (uint)Tuning.kMaxTimesRemovedCousinsToShow)
                        {
                            switch (distantRelationInfo.TimesRemoved)
                            {
                                case 1:
                                    break;
                                case 2:
                                    ancestorTitle = Localization.LocalizeString(isFemale, "Gameplay/Socializing:Grand" + (distantRelationInfo.ClosestDescendant == sim.GetGenealogyPlaceholder() ? "parent" : "child"));
                                    break;
                                case 3:
                                    ancestorTitle = Localization.LocalizeString(isFemale, "Gameplay/Socializing:GG" + (distantRelationInfo.ClosestDescendant == sim.GetGenealogyPlaceholder() ? "P" : "C"));
                                    break;
                                case 4:
                                    ancestorTitle = Localization.LocalizeString(isFemale, "Destrospean/ExpandedGenealogy:GGG" + (distantRelationInfo.ClosestDescendant == sim.GetGenealogyPlaceholder() ? "P" : "C"));
                                    break;
                                default:
                                    string generationalDistance = (distantRelationInfo.TimesRemoved - 1).ToString();
                                    ancestorTitle = Localization.LocalizeString(isFemale, "Destrospean/ExpandedGenealogy:GreatNxGrand" + (distantRelationInfo.ClosestDescendant == sim.GetGenealogyPlaceholder() ? "parent" : "child"), generationalDistance, Localization.LocalizeString(isFemale, "Destrospean/ExpandedGenealogy:OrdinalSuffixAdj" + GetOrdinalSuffix(generationalDistance)));
                                    break;
                            }
        ...
        public override string GetSiblingOfAncestorString(bool isFemale, Genealogy descendantOfSibling, Genealogy siblingOfAncestor, bool isStepRelative = false)
        {
            foreach (Genealogy sibling in siblingOfAncestor.Siblings)
            {
                if (descendantOfSibling.IsAncestor(sibling) || (isStepRelative && descendantOfSibling.IsStepAncestor(sibling)))
                {
                    ...
                    string ancestorTitle, generationalDistance = (isStepRelative ? Common.GetStepAncestorInfo(descendantOfSibling.GetGenealogyPlaceholder(), sibling.GetGenealogyPlaceholder()) : Common.GetAncestorInfo(descendantOfSibling, sibling)).GenerationalDistance.ToString();
                    switch (generationalDistance)
                    {
                        case "1":
                    ...
                    return Tuning.kShow1stCousinsAsCousins ? Localization.LocalizeString(isFemale, isHalfRelative && !Tuning.kShowHalfRelativesAsFullRelatives ? "Destrospean/ExpandedGenealogy:GreatNxHalfUncle" : "Destrospean/ExpandedGenealogy:GreatNxUncle", ancestorTitle.ToLower()) : Localization.LocalizeString(isFemale, isHalfRelative && !Tuning.kShowHalfRelativesAsFullRelatives ? "Destrospean/ExpandedGenealogy:NthHalfCousinNxRemovedUpward" : "Destrospean/ExpandedGenealogy:NthCousinNxRemovedUpward", "1", Localization.LocalizeString(isFemale, "Destrospean/ExpandedGenealogy:OrdinalSuffixNoun1"), ancestorTitle.ToLower(), isStepRelative ? Localization.LocalizeString(isFemale, "Destrospean/ExpandedGenealogy:Step") : "");
                }
            }
            return "";
        }
